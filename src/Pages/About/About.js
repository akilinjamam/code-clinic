...
const About = () => {
    return (
        <div className='mt-10'>
            <h1 className="text-4xl font-semibold text-sky-700 pl-5">About Coder Clinic</h1>
            <div className='mt-5 font-semibold'>
                <div className='bg-gradient-to-r from-sky-100 to-indigo-100 p-10 text-gray-700 rounded-2xl'>
                    <p className='font-semibold'>Code Clinic is a web application built to help you practice programming and improve your coding skills. We create simplified and interactive learning experiences. Learning web development should be easy to understand and available for everyone, everywhere! Code Clinic is a learning plartform for web developers, covering the aspects of web development.</p>
                </div>
            </div>
            <div className='mt-5 text-center p-5'>
                <h2 className='text-4xl font-bold lg:text-fuchsia-700'>A Student Will Learn</h2>
