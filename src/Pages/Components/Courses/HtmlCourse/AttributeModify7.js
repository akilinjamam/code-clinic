...
const AttributeModify7 = () => {
    ...
    const handleModify = event => {
        ...
        const updateHtmlData7 = {
            description1: description1,
        }
        // sending data to server
        const url = `http://localhost:5000/htmlAtt/description1/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(updateHtmlData7)
        })
            .then(res => {
                console.log(res)
                return res.json()
            ...
            <form onSubmit={handleModify} action="">
                ...
                <div className='p-5'>
                    ...
                    <div className='bg-gray-300 p-5 rounded'>
                        ...
                        <p> {dataaAtt.map(d => d.description1)} </p>
                        <br />
...
export default AttributeModify7;