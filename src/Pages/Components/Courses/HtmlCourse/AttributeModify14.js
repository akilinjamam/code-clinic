...
const AttributeModify14 = () => {
    ...
    const handleModify = event => {
        ...
        const updateHtmlData14 = {
            example3: example3,
        }
        // sending data to server
        const url = `http://localhost:5000/htmlAtt/example3/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(updateHtmlData14)
        })
            .then(res => {
                console.log(res)
                return res.json()
...
export default AttributeModify14;