...
const HtmlStyleModify8 = () => {
    ...
    const handleModify = event => {
        ...
        const updateStyleData8 = {
            description2: description2,
        }

        // sending data to server
        const url = `http://localhost:5000/htmlStyle/description2/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(updateStyleData8)
        })
            .then(res => {
                console.log(res)
                return res.json()
            ...
            <form onSubmit={handleModify} action="">
                <div className='p-5'>
                    ...
                    <div className='bg-gray-300 p-5 rounded'>
                        ...
                        <p> {dataaStyle.map(d => d.description2)} </p>
                        <br />
...
export default HtmlStyleModify8;