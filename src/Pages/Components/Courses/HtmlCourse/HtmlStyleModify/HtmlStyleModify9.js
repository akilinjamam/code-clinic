...
const HtmlStyleModify9 = () => {
    ...
    const handleModify = event => {
        ...
        const updateStyleData9 = {
            description3: description3,
        }

        // sending data to server
        const url = `http://localhost:5000/htmlStyle/description3/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(updateStyleData9)
        })
            .then(res => {
                console.log(res)
                return res.json()
...
export default HtmlStyleModify9;