...
const HtmlImageModify16 = () => {
    ...
    const handleModify = event => {
        ...
        const updateImageData16 = {
            example5: example5,
        }

        // sending data to server
        const url = `http://localhost:5000/htmlImage/example5/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(updateImageData16)
        })
            .then(res => {
                console.log(res)
                return res.json()
            ...
            <form onSubmit={handleModify} action="">
                <div className='p-5'>
                    ...
                    <div className='bg-gray-300 p-5 rounded'>
                        ...
                        <p> {dataaStyle.map(d => d.example5)} </p>
                        <br />
...
export default HtmlImageModify16;