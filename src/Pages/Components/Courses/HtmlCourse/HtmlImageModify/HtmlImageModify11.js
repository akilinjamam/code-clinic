...
const HtmlImageModify11 = () => {
    ...
    const handleModify = event => {
        ...
        const updateImageData11 = {
            description5: description5,
        }

        // sending data to server
        const url = `http://localhost:5000/htmlImage/description5/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(updateImageData11)
        })
            .then(res => {
                console.log(res)
                return res.json()
...
export default HtmlImageModify11;