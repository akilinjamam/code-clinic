...
const HtmlImageModify9 = () => {
    ...
    const handleModify = event => {
        ...
        const updateImageData9 = {
            description3: description3,
        }

        // sending data to server
        const url = `http://localhost:5000/htmlImage/description3/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(updateImageData9)
        })
            .then(res => {
                console.log(res)
                return res.json()
            ...
            <form onSubmit={handleModify} action="">
                <div className='p-5'>
                    ...
                    <div className='bg-gray-300 p-5 rounded'>
                        ...
                        <p> {dataaStyle.map(d => d.description3)} </p>
                        <br />
...
export default HtmlImageModify9;