...
const AttributeModify11 = () => {
    ...
    const handleModify = event => {
        ...
        const updateHtmlData11 = {
            description5: description5,
        }
        // sending data to server
        const url = `http://localhost:5000/htmlAtt/description5/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(updateHtmlData11)
        })
            .then(res => {
                console.log(res)
                return res.json()
            ...
            <form onSubmit={handleModify} action="">
                ...
                <div className='p-5'>
                    ...
                    <div className='bg-gray-300 p-5 rounded'>
                        ...
                        <p> {dataaAtt.map(d => d.description5)} </p>
                        <br />
...
export default AttributeModify11;