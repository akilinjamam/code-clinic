...
const HtmlCceModify10 = () => {
    ...
    const handleModify = event => {
        ...
        const updateCceData10 = {
            description4: description4,
        }

        // sending data to server
        const url = `http://localhost:5000/htmlCce/description4/${id}`
        fetch(url, {
            method: 'PUT',
            headers: {
                'content-type': 'application/json'
            },
            body: JSON.stringify(updateCceData10)
        })
            .then(res => {
                console.log(res)
                return res.json()
            ...
            <form onSubmit={handleModify} action="">
                <div className='p-5'>
                    ...
                    <div className='bg-gray-300 p-5 rounded'>
                        ...
                        <p> {dataaCce.map(d => d.description4)} </p>
                        <br />
...
export default HtmlCceModify10;