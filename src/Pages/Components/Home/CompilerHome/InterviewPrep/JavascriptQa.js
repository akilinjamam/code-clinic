    ...
    return (
        <div className='m-5 p-8'>
            ...
            <div className=' hover:shadow-lg hover:shadow-white px-5 pb-4'>
                ...
                <p className='text-white'><span className='text-black font-semibold'>Answer:</span> <br />
            ...
            <div className='hover:shadow-lg hover:shadow-white px-5 pb-4'> <h1 className='text-yellow-500 font-semibold mt-5'>Question-06:  Tell me about bind, call and apply.
                ...
                <p className='text-white'><span className='text-black font-semibold'>Answer:</span> <br /> Bind is executed at the time when we execute the return function. It can take an array and any number of arguments as parameters. It returns a new function or copies a function.
